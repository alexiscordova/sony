$(document).ready(function(){$(document).on("keydown",function(a){if(a.which===191&&a.shiftKey){$("body").toggleClass("debug");(function(j,d){var h=j,g=false,c=0;if(!d.getElementById("tm-window-resizer")){var f=d.createElement("div");f.style.position="fixed";f.style.zIndex="9999";f.style.bottom="0";f.style.right="0";f.style.backgroundColor="rgba(126,255,0,0.8)";f.style.height="20px";f.style.width="126px";f.style.display="block";f.id="tm-window-resizer";var k=d.createElement("p");k.style.color="#000";k.style.fontSize="11px";k.style.fontFamily="Helvetica,Arial,sans-serif";k.style.display="block";k.style.margin="4px 3px 0 7px";k.id="tm-resizer-text";f.appendChild(k);d.body.appendChild(f);var b=function(i){clearTimeout(c);c=setTimeout(function(){h.console.log(h.innerWidth);k.innerHTML="Window Width: "+h.innerWidth+"px"},100)};k.innerHTML="Window Width: "+h.innerWidth+"px";h.addEventListener("resize",b)}else{if(d.getElementById("tm-window-resizer").style.display==="none"){d.getElementById("tm-window-resizer").style.display="block"}else{d.getElementById("tm-window-resizer").style.display="none"}}})(window,document)}})});window.enquire=(function(d){function e(m,k){var j=0,l=m.length,h;for(j;j<l;j++){h=k(m[j],j);if(h===false){break}}}function a(h){return Object.prototype.toString.apply(h)==="[object Array]"}function g(h){return typeof h==="function"}function b(h){this.initialised=false;this.options=h;if(!h.deferSetup){this.setup()}}b.prototype={setup:function(h){if(this.options.setup){this.options.setup(h)}this.initialised=true},on:function(h){if(!this.initialised){this.setup(h)}this.options.match(h)},off:function(h){if(this.options.unmatch){this.options.unmatch(h)}},destroy:function(){if(this.options.destroy){this.options.destroy()}else{this.off()}},equals:function(h){return this.options===h||this.options.match===h}};function c(i,h){this.query=i;this.isUnconditional=h;this.handlers=[];this.matched=false}c.prototype={matchMedia:function(){return d(this.query).matches},addHandler:function(i,j){var h=new b(i);this.handlers.push(h);j&&this.matched&&h.on()},removeHandler:function(i){var h=this.handlers;e(h,function(k,j){if(k.equals(i)){k.destroy();return !h.splice(j,1)}})},assess:function(h){if(this.matchMedia()||this.isUnconditional){this.match(h)}else{this.unmatch(h)}},match:function(h){if(this.matched){return}e(this.handlers,function(i){i.on(h)});this.matched=true},unmatch:function(h){if(!this.matched){return}e(this.handlers,function(i){i.off(h)});this.matched=false}};function f(){if(!d){throw new Error("matchMedia is required")}var h=new c("only all");this.queries={};this.listening=false;this.browserIsIncapable=!h.matchMedia()}f.prototype={register:function(m,j,l){var i=this.queries,h=l&&this.browserIsIncapable,k=this.listening;if(!i.hasOwnProperty(m)){i[m]=new c(m,h);this.listening&&i[m].assess()}if(g(j)){j={match:j}}if(!a(j)){j=[j]}e(j,function(n){i[m].addHandler(n,k)});return this},unregister:function(j,i){var h=this.queries;if(!h.hasOwnProperty(j)){return this}if(!i){e(this.queries[j].handlers,function(k){k.destroy()});delete h[j]}else{h[j].removeHandler(i)}return this},fire:function(i){var h=this.queries,j;for(j in h){if(h.hasOwnProperty(j)){h[j].assess(i)}}return this},listen:function(j){var i=this;j=j||500;function h(k){var l;window.addEventListener(k,function(m){l&&clearTimeout(l);l=setTimeout(function(){i.fire(m)},j)},false)}if(this.listening){return this}if(window.addEventListener){h("resize");h("orientationChange")}i.fire();this.listening=true;return this}};return new f()}(window.matchMedia));if(!window.Exports){window.Exports={Modules:{}}}Exports.fiveColumns=5;Exports.sixColumns=6;Exports.twelveColumns=12;Exports.col5Width=188;Exports.gut5Width=20;Exports.fullSlimWidth=(Exports.fiveColumns*Exports.col5Width)+(Exports.gut5Width*(Exports.fiveColumns-1));Exports.COLUMN_WIDTH_SLIM_5=Exports.col5Width/Exports.fullSlimWidth;Exports.GUTTER_WIDTH_SLIM_5=Exports.gut5Width/Exports.fullSlimWidth;Exports.slimColWidth=54;Exports.slimGutWidth=18;Exports.slimWidth=(Exports.twelveColumns*Exports.slimColWidth)+(Exports.slimGutWidth*(Exports.twelveColumns-1));Exports.COLUMN_WIDTH_SLIM=Exports.slimColWidth/Exports.slimWidth;Exports.GUTTER_WIDTH_SLIM=Exports.slimGutWidth/Exports.slimWidth;Exports.colWidth320=36;Exports.gutWidth320=12;Exports.fullWidth320=(Exports.sixColumns*Exports.colWidth320)+(Exports.gutWidth320*(Exports.sixColumns-1));Exports.COLUMN_WIDTH_320=Exports.colWidth320/Exports.fullWidth320;Exports.GUTTER_WIDTH_320=Exports.gutWidth320/Exports.fullWidth320;Exports.masonryColumns=function(b){var a=b;if(!Modernizr.mediaqueries||Modernizr.mq("(min-width: 35.5em)")){a=Exports.COLUMN_WIDTH_SLIM*b}return a};Exports.masonryGutters=function(a){var b=0;if(!Modernizr.mediaqueries||Modernizr.mq("(min-width: 35.5em)")){b=Exports.GUTTER_WIDTH_SLIM*a}return b};Exports.constrain=function(c,b,a){c=parseFloat(c);return c<b?b:c>a?a:c};var sony=sony||{};window.iQ={options:{speedTestExpireMinutes:30,asyncDistance:500,updateOnResize:true}};window.enquire.listen(100);(function(){var e,d=function(){},b=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],c=b.length,a=(window.console=window.console||{});while(c--){e=b[c];if(!a[e]){a[e]=d}}}());(function(c,d,a,e){var b=function(g){var f=this;f.searchMenu={};f.$container=g;f.$activeNavBtns=f.$container.find(".nav-dropdown-toggle");f.$currentOpenNavBtn=false;f.$pageWrapOuter=c("#page-wrap-outer");f.mobileNavIScroll=false,f.mobileNavVisible=false;f.mobileNavThreshold=767;f.mobileFooterThreshold=567;f.mouseLeaveDelay=1000;f.mouseleaveTimer=false;f.transEndEventNames={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",msTransition:"MSTransitionEnd",transition:"transitionend"};f.tapOrClick=f.hasTouch?"touchstart":"click";f.transformName=d.prefixed("transform");f.transitionName=d.prefixed("transition");f.transitionProperty=d.prefixed("transitionProperty");f.transitionDuration=d.prefixed("transitionDuration");f.transitionEasing=d.prefixed("transitionTimingFunction");f.transitionEnd=f.transEndEventNames[f.transitionName];f.init()};b.prototype={constructor:b,init:function(){var f=this;f.isInitialized=true;a.enquire.register("(min-width: "+(f.mobileNavThreshold+1)+"px)",{match:function(){f.initDesktopNav();f.resetMobileNav()}});a.enquire.register("(min-width: "+(f.mobileFooterThreshold+1)+"px)",{match:function(){f.resetMobileFooter()}});a.enquire.register("(max-width: "+f.mobileNavThreshold+"px)",{match:function(){f.initMobileNav();f.resetDesktopNav()}});a.enquire.register("(max-width: "+f.mobileFooterThreshold+"px)",{match:function(){f.initMobileFooter()}})},initDesktopNav:function(){var f=this;f.$activeNavBtns.each(function(){var h=c(this),j=c("."+h.data("target")),g=h.add(j);f.resetActiveNavBtn(h);if(c("body").hasClass("touch")){h.on("touchstart",function(){if(h.parent().hasClass("nav-li-selected")){f.resetActiveNavBtn(f.$currentOpenNavBtn);f.$currentOpenNavBtn=false}else{var l=f.$currentOpenNavBtn!==false?true:false;if(!l){f.setActiveNavBtn(h)}else{f.resetActiveNavBtn(f.$currentOpenNavBtn);var k=c("."+f.$currentOpenNavBtn.data("target"));if(k.hasClass("navtray-w")){setTimeout(function(){f.setActiveNavBtn(h)},350)}else{setTimeout(function(){f.setActiveNavBtn(h)},150)}}}})}else{var i="mouseenter";if(h.parent().hasClass("nav-li-search")){i="click"}h.on(i,function(){c(this).data("hovering",true);f.resetMouseleaveTimer();if(!h.parent().hasClass("nav-li-selected")){var l=f.$currentOpenNavBtn!==false?true:false;if(!l){f.setActiveNavBtn(h)}else{f.resetActiveNavBtn(f.$currentOpenNavBtn);var k=c("."+f.$currentOpenNavBtn.data("target"));if(k.hasClass("navtray-w")){setTimeout(function(){f.setActiveNavBtn(h)},350)}else{setTimeout(function(){f.setActiveNavBtn(h)},150)}}}});h.on("mouseleave",function(){c(this).data("hovering",false);setTimeout(function(){if(!j.data("hovering")){f.startMouseleaveTimer(h)}else{f.resetMouseleaveTimer()}},25)});j.on("mouseenter",function(){c(this).data("hovering",true);f.resetMouseleaveTimer()});j.on("mouseleave",function(){c(this).data("hovering",false);setTimeout(function(){if(!h.data("hovering")){f.startMouseleaveTimer(h)}else{f.resetMouseleaveTimer()}},25)})}})},resetDesktopNav:function(){var f=this;f.$activeNavBtns.each(function(){var h=c(this),i=c("."+h.data("target"));h.removeClass("active").parent().removeClass("nav-li-selected");if(h.data("target").length){var g=c("."+h.data("target"));if(g.hasClass("navtray-w")){f.setNavTrayContentNaturalFlow(g,false)}else{c(".navmenu-w-visible").removeClass("navmenu-w-visible").one(f.transitionEnd,function(){c(this).css({left:"",right:""}).find(".reveal-transition-container").css("height","")})}}h.off("touchstart mouseenter mouseleave click");i.off("touchstart mouseenter mouseleave click")})},startMouseleaveTimer:function(g){var f=this;if(c("mouseleaveTimerActive").length){f.resetMouseleaveTimer()}g.addClass("mouseleaveTimerActive");f.mouseleaveTimer=setTimeout(function(){f.resetActiveNavBtn(g);f.resetMouseleaveTimer()},f.mouseLeaveDelay)},resetMouseleaveTimer:function(){var f=this;clearTimeout(f.mouseleaveTimer);c(".mouseleaveTimerActive").removeClass("mouseleaveTimerActive")},setActiveNavBtn:function(g){var f=this;f.activateNavBtn(g);f.$currentOpenNavBtn=g},resetActiveNavBtn:function(h){var g=this;!!h&&h.removeClass("active").parent().removeClass("nav-li-selected");if(!!h.data("target")){var f=c("."+h.data("target"));if(f.hasClass("navtray-w")){g.slideNavTray(f,false)}else{c(".navmenu-w-visible").removeClass("navmenu-w-visible").one(g.transitionEnd,function(){c(this).css({left:"",right:""}).find(".reveal-transition-container").css("height","")})}}},slideNavTray:function(h,g){var j=this,f,l,k=h.outerHeight();h.data("expandedHeight",k);if(g){f="1px";l=k}else{f=k;l="1px"}h.data("expandedHeight",f).css("height",f).find(".navtray").addClass("navtray-absolute").css("height",k);setTimeout(function(){h.removeClass("no-transition");setTimeout(function(){h.css("height",l).one(j.transitionEnd,i);if(g){h.addClass("navtray-w-visible")}else{h.removeClass("navtray-w-visible")}},10)},10);function i(){j.setNavTrayContentNaturalFlow(h)}},resetNavTray:function(f){var g=this;f.removeClass("navtray-w-visible").css("height","").find(".navtray").removeClass("navtray-absolute").css("height","")},setNavTrayContentNaturalFlow:function(f){f.css("height","").addClass("no-transition").find(".navtray").removeClass("navtray-absolute").css("height","")},activateNavBtn:function(k){var i=this;k.addClass("active").parent().addClass("nav-li-selected");if(k.data("target").length){var f=c("."+k.data("target"));if(f.hasClass("navtray-w")){if(c("body").hasClass("lt-ie10")){i.slideNavTray(f,true)}else{i.slideNavTray(f,true)}}else{var g=f.find(".reveal-transition-container");var h=g.height();console.log("expHeight: "+h);g.css("height","0px");setTimeout(function(){g.addClass("transition-height");setTimeout(function(){f.addClass("navmenu-w-visible");g.height(h);g.one(i.transitionEnd,function(){g.removeClass("transition-height");setTimeout(function(){g.css("height","")},1)})},1)},1);if(f.hasClass("navmenu-w-search")){var l=k.parent().position().left+parseInt(k.css("marginLeft"),10)+k.innerWidth();var j=l-f.innerWidth();f.css({right:"auto",left:j+"px"})}}}},initMobileNav:function(){var f=this;c("#btn-mobile-nav").on(f.tapOrClick,function(){if(!f.mobileNavVisible){f.showMobileNav()}else{f.hideMobileNav()}})},resetMobileNav:function(){var f=this;c("#btn-mobile-nav").off(f.tapOrClick)},showMobileNav:function(){var g=this;g.showMobileBackdrop();var h=parseInt(c(a).height(),10)+60+"px";g.$pageWrapOuter.height(h);if(!g.mobileNavIScroll){var f=c("#nav-outer-container"),i=f.find(".nav-mobile-scroller");f.height(h);i.height(i.height());setTimeout(function(){g.mobileNavIScroll=new a.IScroll("nav-outer-container",{vScroll:true,hScroll:false,hScrollbar:false,snap:false,momentum:true,bounce:false});g.mobileNavIScroll.options.onBeforeScrollStart=function(k){var j=k.target;while(j.nodeType!=1){j=j.parentNode}if(j.tagName!="SELECT"&&j.tagName!="INPUT"&&j.tagName!="TEXTAREA"){k.preventDefault()}}},1)}c("#page-wrap-inner").addClass("show-mobile-menu");g.mobileNavVisible=true},hideMobileNav:function(){var f=this;f.hideMobileBackdrop();c("#page-wrap-inner").one(f.transitionEnd,function(){f.mobileNavIScroll.destroy();f.mobileNavIScroll=false;f.$pageWrapOuter.css("height","")});c("#page-wrap-inner").removeClass("show-mobile-menu");f.mobileNavVisible=false},showMobileBackdrop:function(){var f=this;f.$mobileScreenOverlay=c('<div class="modal-backdrop mobile-screen-overlay opacity0" />').appendTo(c("#page-wrap-inner"));setTimeout(function(){f.$mobileScreenOverlay.removeClass("opacity0").addClass("opacity1")},1)},hideMobileBackdrop:function(){var f=this;f.$mobileScreenOverlay.one(f.transitionEnd,function(){f.$mobileScreenOverlay.remove()});f.$mobileScreenOverlay.removeClass("opacity1").addClass("opacity0")},initMobileFooter:function(){var f=this;f.footerNavCollapseHeight=49;c("#footer-wrapper .footer-mobile-section h5").each(function(){var g=c(this).parent();f.collapseMobileFooterSec(g,true);c(this).on(f.tapOrClick,function(){if(g.hasClass("collapsed")){f.expandMobileFooterSec(g)}else{f.collapseMobileFooterSec(g)}})})},resetMobileFooter:function(){var f=this;c("#footer-wrapper .footer-mobile-section h5").each(function(){var g=c(this).parent();g.css("height","").removeClass("collapsed transition-height");c(this).off(f.tapOrClick)})},collapseMobileFooterSec:function(i,h){var g=this;h=typeof h!=="undefined"?h:false;var f=i.height();i.data("expHeight",f);if(h){i.height(g.footerNavCollapseHeight).addClass("collapsed");setTimeout(function(){i.addClass("transition-height")},1)}else{i.height(f);setTimeout(function(){i.addClass("transition-height");setTimeout(function(){i.height(g.footerNavCollapseHeight).addClass("collapsed")},1)},1)}},expandMobileFooterSec:function(g){var f=this;g.height(g.data("expHeight")).removeClass("collapsed").one(f.transitionEnd,function(){g.removeClass("transition-height");setTimeout(function(){g.css("height","")},1)})}};c.fn.globalNav=function(g){var f=Array.prototype.slice.apply(arguments);return this.each(function(){var h=c(this),i=h.data("globalNav");if(!i){i=new b(h);h.data("globalNav",i)}if(typeof g==="string"){i[g].apply(i,f.slice(1))}})};c.fn.globalNav.options={sampleOption:0};c.fn.globalNav.settings={isTouch:!!("ontouchstart" in a),isInitialized:false}})(jQuery,Modernizr,window);$(function(){$(window).load(function(){$(".nav-wrapper").globalNav()})});(function(a){var b=function(c,e){var d=this;d.$el=c;d.init()};b.prototype={constructor:b,init:function(){var c=this;c.clickEvent()},clickEvent:function(){var c=this;c.$el.on("click.tracking",function(k){var i=a(k.target).parents("*[data-module-id]"),d=i.data("trackingLog")||[],f=d;i.type=k.type;i.elemID=c.$el.data("moduleId");i.elemName=c.$el.data("moduleName");i.$actionInitElem=k.target;var j=Date.now();var h=[i.type,i.$actionInitElem,i.elemID,i.elemName,j];d.push(h);i.data("trackingLog",f);var g})}};jQuery.fn.globalTracking=function(d){var c=Array.prototype.slice.call(arguments,1);return this.each(function(){var e=a(this),f=e.data("globalTracking");if(!f){f=new b(e,d);e.data("globalTracking",f)}if(typeof d==="string"){f[d].apply(f,c)}})};a(function(){a("*[data-module-id]").globalTracking()})})(jQuery);(function(L,al,N){L.images=[];L.resizeFlaggedImages=[];L.options=L.options||{};function ai(aI,aJ){var aG,aD,aE,aK,aF=0;function aH(){aF=new Date;aK=null;aI.apply(aE,aG)}return function(){var aL=new Date,aM=aJ-(aL-aF);aG=arguments;aE=this;if(aM<=0){aF=aL;aD=aI.apply(aE,aG)}else{if(!aK){aK=aa(aH,aM)}}return aD}}function aC(aI,aJ,aF){var aH,aD,aE,aK;function aG(){aK=null;if(!aF){aI.apply(aE,aH)}}return function(){var aL=aF&&!aK;aH=arguments;aE=this;clearTimeout(aK);aK=aa(aG,aJ);if(aL){aD=aI.apply(aE,aH)}return aD}}var v="iqjs",Y="high",u="low",T="length",j="scroll",V="resize",at="complete",P=200,ah="",af="on",R="load",n=af+at,O="orientation",k="EventListener",d="add"+k,ax=O+"change",az=L.options,W=az.jquerySelector||".iq-img",o=az.minDevicePixelRatio||2,aA=az.highResPathSuffix||"@2x",I=az.asyncDistance||0,s=az.base||"",Z=az.pathTemplate||"{fileName}-{breakpoint}{highRes}.{ext}",X=/\?/,aj=/\{breakpoint\}/gi,p=/\{highRes\}/gi,au=/\{fileName\}/gi,c=/\{ext\}/gi,an,A,aq=az.breakpoints||[{name:"phone",maxWidth:480},{name:"tablet",minWidth:481,maxWidth:768},{name:"desktop",minWidth:769,defaultBreakpoint:true}],aw=u,ap,ag,ay,q=az.minKbps||300,K=az.speedTestUri||"http://foresightjs.appspot.com/speed-test/50K",l=az.speedTestKB||50,e=az.speedTestExpireMinutes||30,ao=az.updateOnResize||false,ac=az.resizeFlag||"update-always",r=az.noFadeFlag||"no-fade",ar=az.fade||"true",U=window,t=U.document,aB=t.documentElement,aa=U.setTimeout,F=d in t,C=F?ah:af,h=F?d:"attachEvent",D=F?"remove"+k:"detachEvent",f=O in U&&af+ax in U,Q,w=U.screen.width,g=U.devicePixelRatio||1,z,x=ai(function(){ad(false)},P),E=aC(function(){ad(true)},P),a=aC(function(){if(U[O]!==z){z=U[O];ad(true)}},P),H=function(){Q=Q||ab();an=B(aq,Q);A=an.name;ad()},am=function(aD){ad(false,aD===true)},b=function(aD){if(ar&&al(aD).data("fadeonce")!==true&&!al(aD).hasClass(r)){al(aD).data("fadeonce",true);al(aD).css({opacity:1,"-ms-filter":'"progid:DXImageTransform.Microsoft.Alpha(opacity=100)"',filter:"alpha(opacity=100)"})}},ad=function(aD,aG){var aF,aE;if(!L.images[T]||aG===true||(ao===true&&aD)){ae();L.images=[];al(W).each(function(aH,aI){L.images.push(aI);al(aI).hasClass(ac)&&L.resizeFlaggedImages.push(aI);if(aI.tagName=="IMG"){if(ar&&al(aI).data("fadeonce")!==true&&!al(aI).hasClass(r)){al(aI).css({opacity:0,"-ms-filter":'"progid:DXImageTransform.Microsoft.Alpha(opacity=0)"',filter:"alpha(opacity=0)",zoom:1,"-webkit-transition":"opacity 0.4s ease-out","-moz-transition":"opacity 0.4s ease-out","-o-transition":"opacity 0.4s ease-out",transition:"opacity 0.4s ease-out"})}al(aI).imagesLoaded(b)}})}if(L.images[T]){aE=0;while(aF=L.images[aE]){if(aF&&i(aF,I)){M(aF,aE);L.images.splice(aE,1);aE--}aE++}}if(L.resizeFlaggedImages[T]){aE=0;while(aF=L.resizeFlaggedImages[aE]){if(aF&&i(aF,I)){M(aF,aE)}aE++}}!L.images[T]&&!L.resizeFlaggedImages[length]&&S();!L.images[T]&&n in L.options&&L.options[n]();aF=null},M=function(aD){Q=ab();an=B(aq,Q);A=an.name;var aE=ak(aD,A);if(al(aD).data("current")!==aE){al(aD).data("current",aE);av(aD,aE)}},av=function(aD,aE){if(al(aD).is("img")){aD.src=aE}else{if(al(aD).is("div")){al(aD).css("background-image","url("+aE+")")}}},ae=function(){G(U,j,x);G(U,V,E);if(f){z=U[O];G(U,ax,a)}},S=function(){J(U,j,x);!ao&&J(U,V,E);f&&J(U,ax,a)},y=function(){if(ag){return}if(az.forceBandwidth){aw=az.forceBandwidth;ap="force";ag=at;return}if(g===1){ap="skip";ag=at;return}var aF=navigator.connection||{type:"unknown"};var aI=aF.type===3||aF.type===4||/^[23]g$/.test(aF.type);if(aI){ap="connTypeSlow";ag=at;return}try{var aD=JSON.parse(localStorage.getItem(v));if(aD!==null){if((new Date()).getTime()<aD.exp){aw=aD.bw;ay=aD.kbps;ap="localStorage";ag=at;return}}}catch(aK){}var aH=document.createElement("img"),aE,aJ,aG;aH.onload=function(){aE=(new Date()).getTime();var aL=(aE-aJ)/1000;aL=(aL>1?aL:1);ay=((l*1024*8)/aL)/1024;aw=(ay>=q?Y:u);m("networkSuccess")};aH.onerror=function(){m("networkError",5)};aH.onabort=function(){m("networkAbort",5)};aJ=(new Date()).getTime();ag="loading";if(document.location.protocol==="https:"){K=K.replace("http:","https:")}aH.src=K+"?r="+Math.random();aG=(((l*8)/q)*1000)+350;aa(function(){m("networkSlow")},aG)},m=function(aG,aE){if(ag===at){return}ag=at;aG=aG;try{if(!aE){aE=e}var aD={kbps:ay,bw:aw,exp:(new Date()).getTime()+(aE*60000)};localStorage.setItem(v,JSON.stringify(aD))}catch(aF){}},B=function(aG,aD){var aH=aD,aF=0,aI={},aL,aE,aJ,aK;while(aL=aG[aF]){aE=aL.minWidth;aJ=aL.maxWidth;aK=aL.defaultBreakpoint?aL:aK;if(aD>0){if(aE&&aJ&&aD>=aE&&aD<=aJ||aE&&!aJ&&aD>=aE||aJ&&!aE&&aD<=aJ){aI=aL}}else{if(aH<=0||aE<aH||aJ<aH){aH=aE||aJ||aH;aI=aL}}aF++}return N.mediaqueries?aI:aK},ab=function(){var aG=[aB.clientWidth,aB.offsetWidth,t.body.clientWidth],aD=aG[T],aE=0,aF;for(;aE<aD;aE++){if(isNaN(aG[aE])){aG.splice(aE,1);aE--}}if(aG[T]){aF=Math.max.apply(Math,aG);if(!isNaN(w)){aF=Math.min(w,aF)}}return aF||w||0},ak=function(aD,aE,aF){var aG=(al(aD).data("base")||s)+Z,aH=(al(aD).data("src")||ah).split(".");aG=aG.replace(aj,aE);aG=aG.replace(au,aH[0]);aG=aG.replace(c,aH[1]);aG=aG.replace(p,(aw===Y&&g>=o)?aA:ah);if(aF){aG+=(X.test(aG)?"&":"?");aG+="riloadrts="+(new Date).getTime()}return aG},i=function(aJ,aP){var aI=al(window);var aF=aI[0]===window,aO=(aF?{top:0,left:0}:aI.offset()),aG=aO.top+(aF?aI.scrollTop():0),aH=aO.left+(aF?aI.scrollLeft():0),aE=aH+aI.width(),aK=aG+aI.height(),aN=al(aJ).offset(),aM=al(aJ).width(),aD=al(aJ).height();var aL=(aG-aP)<=(aN.top+aD)&&(aK+aP)>=aN.top&&(aH-aP)<=(aN.left+aM)&&(aE+aP)>=aN.left;return aL};function G(aF,aE,aD){aF[h](C+aE,aD,false)}function J(aF,aE,aD){aF[D](C+aE,aD,false)}L.ready=function(){if(!document.body){return window.setTimeout(L.ready,1)}H()};if(document.readyState===at){aa(L.ready,1)}else{G(U,R,L.ready)}if(az.forcePixelRatio){g=az.forcePixelRatio}L.update=am;y()}(this.iQ=this.iQ||{},jQuery,Modernizr));
/*!
