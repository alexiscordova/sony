(function() {
  ...
  this.ecoTemplates["primary_tout_module.html"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push(this.partial('modules/primary_tout.html.eco', {
          "this": this,
          data: this.data('primary_tout/default.json')
        }));
