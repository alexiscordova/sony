(function() {
  ...
  this.ecoTemplates["example_1354846396.html"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push(this.partial('modules/example.html.hb', this, this.data('example/default.json')));
