...
$ ( document ).ready ( function ( ) {
  ...
  mb.mainCodeEditor = CodeMirror ( function ( elt ) {
  ...
  mb.popupCodeEditor = CodeMirror ( function ( elt ) {
  ...
  $ ( '#data_select' ).change ( function ( e ) {
    ...
    $.ajax ( {
      ...
      if ( mb.moduleData.config === undefined || mb.moduleData.config.superModule === undefined ) {
      ...
      if ( mb.moduleData.config.superModule ) {
        ...
        //if the superModule have no subModule we provide a default one.
        mb.subModules = mb.subModules || [{
          "data" : "default/default.json",
          "type" : "default.html.eco"
        }];
