(function() {
  ...
  this.ecoTemplates["editorial_1354911677.html"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push(this.partial('modules/editorial.html.eco', this, this.data('editorial/default.json')));
