(function() {
  ...
  this.ecoTemplates["gallery_module.html"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push(this.partial('modules/gallery.html.hb', {
          "this": this,
          data: this.data('gallery/default.json')
        }));
