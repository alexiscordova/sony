...
<section class="gallery-module">
	...
	<div class="tab-strip gallery-tabs">
	  ...
	  <div class="tabs-container container-fluid">
	    <div class="tabs">
	      {{#each data.tabs}}<div class="tab ghost-center-wrap{{#if this.first}} active{{/if}}" data-target="{{this.slug}}" data-toggle="tab">
	...
	<div class="tab-content">
	  ...
	  <div class="tab-pane fade" data-tab="cameras">
	    <section class="gallery" data-mode="{{data.productCards.mode}}">
	      ...
	      <div class="filter-display-bar slide-toggle-parent container-fluid padded">
	        ...
	        <div class="sort-options pull-right">
	          ...
	          <div class="dropdown ib hidden-phone">
	            <button class="btn dropdown-toggle dropdown-toggle-alt" data-toggle="dropdown"><span class="js-toggle-text">{{data.productCards.sortSet.[0].label}}</span> <i class="icon-ui-arrowheads-up-down-gray"></i></button>
	  ...
	  <!--
	  <section class="tab-pane fade gallery" data-tab="simple" data-mode="{{data.simple.mode}}">
	    {{#if data.simple.filterSet}}
	    <div class="container-fluid padded">
	      <button class="btn slide-toggle collapsed" data-toggle="collapse" data-target="#{{data.simple.name}}-filters">Filter Results</button>
	      <span class="active-filters"></span>
	    </div>
	    <div class="collapse product-filter" id="{{data.simple.name}}-filters">
	      <div class="filter-options container-fluid padded">
	        <div class="row-fluid">
	          {{#each data.simple.filterSet}}
	    ...
	    <div class="gallery-title-bar container-fluid padded">
	      {{#if data.simple.sortSet}}
	      <div class="sort-options pull-right">
	        <span class="l4">Sort By:&nbsp;</span>
	        <div class="dropdown">
	          <button class="btn dropdown-toggle dropdown-toggle-alt" data-toggle="dropdown"><span class="js-toggle-text">{{data.simple.sortSet.[0].label}}</span> <i class="icon-ui-arrowheads-up-down-gray"></i></button>
	          <ul class="dropdown-menu" role="menu">
	          {{#each data.simple.sortSet}}
	            <li><a data-value="{{this.name}}" data-reverse="{{this.reverse}}" tabindex="-1" href="#">{{this.label}}</a></li>
	          {{/each}}
	          </ul>
	        </div>
	      ...
	      <p class="l4"><span class="text-dark product-count">{{data.simple.total}}</span> Products</p>
	    </div>
	    <div class="container-fluid padded">
	      <div class="products row-fluid">
	        {{#each data.simple.list}}
