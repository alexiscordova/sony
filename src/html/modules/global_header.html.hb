		    ...
		    <div class="navtray-wrapper navtray-wrapper-fullwidth-3-4 navtray-wrapper-entertainment">
		    	<div class="navtray">
	      		<div class="navtray-section navtray-section-main">
			        <ul class="navtray-list-main">
			        	<li id="navtray-li-cameras"><a href="#" class="tl"><img src="img/global/global-nav/tray-games.png" alt="Games"><span class="nav-label">Games</span></a></li>
			        	<li id="navtray-li-mobile"><a href="#" class="tl"><img src="img/global/global-nav/tray-moviestv.png" alt="Movies &amp; TV Shows"><span class="nav-label">Movies &amp; TV Shows</span></a></li>
			        	<li id="navtray-li-playstation"><a href="#" class="tl"><img src="img/global/global-nav/tray-music.png" alt="Music"><span class="nav-label">Music</span></a></li>
