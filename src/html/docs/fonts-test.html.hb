			        ...
			        <section id="typography">
			          ...
			          <div class="bs-docs-example bs-docs-example-headings">
			            ...
			            <div class="big-bottom-margin">
			              ...
			              <div>
			                <p class="title-docs">SST-Italic</p>
			                <h5 class="SST-Italic">The quick brown fox jumps over the lazy dog</h5>
			              </div>				            
			            	<div>
			                <p class="title-docs">SST-Roman CSS:italic</p>
			                <h5 class="SST-Roman-i">The quick brown fox jumps over the lazy dog</h5>
			              </div>
			            </div>
			            ...
			            <div class="big-bottom-margin">
			              ...
			              <div>
			                <p class="title-docs">SST-Light CSS:italic</p>
			                <h5 class="SST-Light-i">The quick brown fox jumps over the lazy dog</h5>
			              </div>
			            </div>
			            ...
			            <div class="big-bottom-margin">
			              ...
			              <div>
			                <p class="title-docs">SST-Medium CSS:italic</p>
			                <h5 class="SST-Medium-i">The quick brown fox jumps over the lazy dog</h5>
			              </div>
			            </div>
			            ...
			            <div class="big-bottom-margin">
			              ...
			              <div>
			                <p class="title-docs">SST-Roman CSS:bold</p>
			                <h5 class="SST-Roman-b">The quick brown fox jumps over the lazy dog</h5>
			              </div>
			              <div>
			              ...
			              <div>
			                <p class="title-docs">SST-Bold CSS:italic</p>
			                <h5 class="SST-Bold-i">The quick brown fox jumps over the lazy dog</h5>
			              </div>		
			              <div>
			                <p class="title-docs">SST-Roman CSS:bold,italic</p>
			                <h5 class="SST-Roman-b-i">The quick brown fox jumps over the lazy dog</h5>
			              </div>	
			            </div>			   
