	...
	<body data-spy="scroll" data-target=".bs-docs-sidebar">
		{{partial 'includes/docs_nav.html'}}
			...
			================================================== -->
			        <section id="typography">
			          ...
			          <div class="sub-section">
			            ...
			            <h6 class="bs-docs-heading"><code>.p1</code> Supports major features </h6>
			            ...
			            <h6 class="bs-docs-heading"><code>&lt;p&gt;</code> Standard paragraphs, Supports features</h6>
			            <div class="bs-docs-example">
			            ...
			            <h6 class="bs-docs-heading"><code>.p3</code> Supports subheads</h6>
			            <div class="bs-docs-example">
			          ...
			          <div class="sub-section WIP">
			            ...
			            <h6 class="bs-docs-heading"><code>&lt;p&gt;&lt;a class="tl"&gt;...&lt;/a&gt;&lt;/p&gt;</code></h6>
			...
			&lt;p&gt;Lorem ipsum dolor sit amet. &lt;a class="tl" href="#"&gt;Learn more&lt;/a&gt;&lt;/p&gt;
			            ...
			            <h3 class="bs-docs-heading">Standalone TextLinks</h3>
			            <h6 class="bs-docs-heading"><code>&lt;p&gt;&lt;a class="tl-arrow-right"&gt;...&lt;/a&gt;&lt;/p&gt;</code></h6>
			            <div class="bs-docs-example">
			              <p><a class="tl tl-arrow-right" href="#">Shop All E-mount Lenses</a></p>
			            </div>
			<pre class="prettyprint linenums">
			&lt;p&gt;&lt;a class="tl tl-arrow-right" href="#"&gt;Shop All E-mount Lenses&lt;/a&gt;&lt;/p&gt;
			</pre>
			          ...
			          <div class="sub-section">
			            ...
			            <h6 class="bs-docs-heading"><code>&lt;blockquote&gt;</code> Quotes from external sources such as reviews</h6>
			            <p>For quoting blocks of content from another source within your document.</p>
			
			            <h3 class="bs-docs-heading">Personal Quote 1 - Large</h3>
			            <h6 class="bs-docs-heading"><code>&lt;blockquote class="bq1"&gt;&lt;p&gt;</code></h6>
			            <div class="bs-docs-example">
			...
			&lt;/blockquote&gt;
			            ...
			            <h3 class="bs-docs-heading">Personal quote 2 - Default</h3>
			            <h6 class="bs-docs-heading"><code>&lt;blockquote class="bq2"&gt;&lt;p&gt;</code></h6>
			            <div class="bs-docs-example">
			              <blockquote>
			...
			================================================== -->
			        <section id="icons" class="NotUpdatedYet">
			          ...
			          <h4 class="bs-docs-heading">Glyphicons attribution</h4>
			          <p><a href="http://glyphicons.com/">Glyphicons</a> Halflings are normally not available for free, but an arrangement between Bootstrap and the Glyphicons creators have made this possible at no cost to you as developers. As a thank you, we ask you to include an optional link back to <a href="http://glyphicons.com/">Glyphicons</a> whenever practical.</p>
			
			
			
			
			          <h3 class="bs-docs-heading">How to use</h3>
			...
			&lt;i class="icon-search icon-white"&gt;&lt;/i&gt;
			          ...
			          <h3 class="bs-docs-heading">Icon examples</h3>
			          <p>Use them in buttons, button groups for a toolbar, navigation, or prepended form inputs.</p>
			
			          <h5 class="bs-docs-heading">Buttons</h5>
			
			          <h6 class="bs-docs-heading">Button group in a button toolbar</h6>
			          <div class="bs-docs-example">
			...
			&lt;/div&gt;
			          ...
			          <h6 class="bs-docs-heading">Dropdown in a button group</h6>
			          <div class="bs-docs-example">
			            <div class="btn-group">
			              <a class="btn btn-special" href="#"><i class="icon-user icon-white"></i> User</a>
			              <a class="btn btn-special dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
			...
			&lt;/div&gt;
			          ...
			          <h6 class="bs-docs-heading">Small button</h6>
			          <div class="bs-docs-example">
			...
			&lt;a class="btn btn-small" href="#"&gt;&lt;i class="icon-star"&gt;&lt;/i&gt;&lt;/a&gt;
			          ...
			          <h5 class="bs-docs-heading">Navigation</h5>
			          <div class="bs-docs-example">
			...
			&lt;/ul&gt;
			          ...
			          <h5 class="bs-docs-heading">Form fields</h5>
			          <form class="bs-docs-example form-horizontal">
			            <div class="control-group">
