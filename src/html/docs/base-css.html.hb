...
&lt;/p&gt;
			          ...
			          <div class="bs-docs-example">
			            <p>
			              <a class="btn btn-promo text-promo-title"><strong>Exmor<br></strong> Technology<span class="btn-promo-arrow-box"><i class="icon-ui-arrow-right-white"></i></span></a>
			            </p>
			          </div>
			<pre class="prettyprint linenums">
			&lt;p&gt;
...
&lt;/select&gt;
			          ...
			          <form class="bs-docs-example form-fused">
			            <input type="text" class="input-medium" placeholder="City or Postal Code"><button type="submit">Submit<i class="icon-ui-arrow-right-white"></i></button>
			          </form>
<pre class="prettyprint linenums">
&lt;form class="form-fused"&gt;
  &lt;input type="text" class="input-medium" placeholder="City or Postal Code"&gt;&lt;button type="submit"&gt;Submit&lt;i class="icon-ui-arrow-right-blue"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/form&gt;
</pre>
			          ...
			          <form class="bs-docs-example form-fused-alt">
			            <input type="text" class="input-medium" placeholder="Your Email"><button type="submit">Submit<i class="icon-ui-arrow-right-blue"></i></button>
			          </form>
<pre class="prettyprint linenums">
