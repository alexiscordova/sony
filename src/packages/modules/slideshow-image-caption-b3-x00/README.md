...
Module description Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
...
* slideshow-image-caption-b3-x00.js
	*../../../js/bundle/defer/slideshow-image-caption-b3-x00.js

* slideshow-image-caption-b3-x00.scss
	*../../../css/scss/modules/slideshow-image-caption-b3-x00.scss
...
* default.json
	*../../data/slideshow-image-caption-b3-x00/default.json
