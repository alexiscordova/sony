 ...
 'use strict';
  ...
  SenConvergence.prototype = {
    ...
    setupMobilePlus: function() {
      ...
      self.$window.off('resize.e12-mobile-resize');
    ...
    setupMobile: function() {
      ...
      self.$window.on('resize.e12-mobile-resize', $.proxy(self.getSlideHeight, self ));
    ...
    setupCarousel: function(){
      ...
      self.$slideContainer.sonyCarouselFade({
        wrapper: '.sen-carousel-wrapper',
        slides: '.sen-carousel-slide',
        looped: false,
        jumping: false,
        axis: 'x',
    ...
    setCurrentActiveThumb: function(){
      ...
      // stop internal slides from rotating
    ...
    showNextSlide: function() {
      var self = this,
          currentSlideIndex = self.$internalSlides.index(self.$currentSlide),
