...
(function($, undefined) {
  ...
  Tab.prototype = {
    ...
    show : function(showHash) {
      var self = this, $this = self.$el, selector = $this.attr('data-target'), previous, $prevPane, e;
  ...
  $(window).on('hashchange', function() {
    var target = window.location.hash ? window.location.hash.substring(1) : $('[data-target]').first().attr('data-target'), $target = $('[data-target="' + target + '"]'), isAlreadyActive = $target.hasClass('active'), showHash = !!window.location.hash;
