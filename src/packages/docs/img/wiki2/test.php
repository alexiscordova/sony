...
function html_admin(){
    ...
    // So if you can't access the security.png file, you're good, but you'll get a console error because the file isn't accessible. Kinda dumb way of doing this.
